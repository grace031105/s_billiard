...
<div class="container mx-auto px-4 py-6">
  ...
  <div class="meja-detail flex flex-wrap gap-6 my-6">
    ...
    <div class="flex-1">
      ...
      <p class="text-[#333] leading-relaxed">Meja Platinum merupakan pilihan terbaik dengan ukuran profesional 9ft. Dirancang untuk turnamen atau pemain berpengalaman, dilengkapi area duduk mewah, pencahayaan optimal, dan privasi lebih. Nikmati sensasi bermain kelas atas di lingkungan eksklusif.</p>
    </div>
  </div>
  ...
  <div class="daftar-meja">
    ...
    <div class="space-y-4">
      ...
      <div class="flex items-center gap-4 p-4 bg-[#0e0e3e] rounded-xl text-white">
        <img src="{{ asset('/images/gambar6.jpeg') }}" alt="{{ $meja }}" class="w-24 rounded-md" />
