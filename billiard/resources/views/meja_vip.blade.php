...
<div class="container">
  ...
  <div class="meja-detail">
    <img src="/images/gambar5.jpeg"alt="Meja Biliar">
    <div class="meja-info">
      <h2>Meja VIP</h2>
      <p>Meja VIP berukuran 8ft menawarkan ruang bermain yang lebih luas dengan kenyamanan ekstra. Dilengkapi sofa empuk, pencahayaan terang, dan suasana eksklusif untuk pengalaman bermain yang lebih premium.</p>
    </div>
  </div>
  ...
  <div class="daftar-meja">
    ...
    <div class="meja-list">
      <img src="/images/gambar5.jpeg" alt="Meja 1">
      <div class="info">Meja 1</div>
      <button>Pilih Jadwal</button>
    </div>

    <div class="meja-list">
      <img src="/images/gambar5.jpeg" alt="Meja 2">
      <div class="info">Meja 2</div>
      <button>Pilih Jadwal</button>
    </div>

    <div class="meja-list">
      <img src="/images/gambar5.jpeg"alt="Meja 3">
      ...
      <div style="flex: 1; min-width: 150px; display: flex; justify-content: center; align-items: center;">
        <div style="background-color: #f1f5f9; border-radius: 10px; padding: 20px; width: 100%; max-width: 300px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          <div style="display: flex; flex-direction: column; gap: 15px;">
            <div>
              <strong>Tipe Meja :</strong> Meja VIP
            </div>
            <div>
